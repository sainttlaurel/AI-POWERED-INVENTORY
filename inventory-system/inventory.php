...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    if ($action === 'stock_in') {
        ...
        $stmt = $db->prepare("INSERT INTO sales (product_id, quantity, total_price) 
...
// Get inventory logs
$logs = $db->query("SELECT il.*, p.product_name, u.username 
...
$products = $db->query("SELECT id, product_name, stock_quantity 
                        FROM products 
